...
function getLoaderOptions(loader) {
    if (loader.resourcePath.match(/\.vue$/)) debugger
    // if (loader.resourcePath.match(/\.vue$/)) { debugger }
    ...
    if (utils_1.hasOwnProperty(loaderOptionsCache, instanceName)) {
        ...
        let ret = loaderOptionsCache[instanceName]
        Object.assign(ret, {appendTsSuffixTo, appendTsxSuffixTo})
    ...
    // console.log(chalk.underline.blueBright(util.inspect(options)))
    return options;
